...
def update_excel_with_xlwings(file_path):
    ...
    servicios_informaticos = exported.loc["0906", "MONTO "]
    mantenimiento_maquinaria = exported.loc["060501", "MONTO "] + exported.loc["060502", "MONTO "]
    mantenimiento_correctivo = exported.loc["060604", "MONTO "]
    mantenimiento_preventivo = exported.loc["060603", "MONTO "]
    servicio_laboratorio = exported.loc["12990201", "MONTO "]
    seguridad_y_vigilancia = exported.loc["0802", "MONTO "]
    servicio_de_aseo = exported.loc["0801", "MONTO "]
    gasto_medicamentos_x_servicio = exported.loc["129919", "MONTO "]
    servicio_lavanderia = exported.loc["040701", "MONTO "]
    otros_gastos = exported.loc["12990202", "MONTO "]
    mantenimiento_y_reparacion_vehiculo = exported.loc["0602", "MONTO_SUBASIGNACIONES"]
    mantenimiento_planta_fisica = exported.loc["0601", "MONTO "]
    pasaje_traslado_pacientes = exported.loc["129910", "MONTO "]
    mantenimiento_mueble_y_enserses = exported.loc["0603", "MONTO "]
    cursos_capacitacion = exported.loc["1102", "MONTO "] + exported.loc["1103", "MONTO_SUBASIGNACIONES"]
    coloc_adulto_mayor = exported.loc["12990603", "MONTO "]



    # Extract values for SUMINISTROS sheet
    combustible_vehiculos = exported.loc["0301", "MONTO "]
    ...
    gasas_medicinales = exported.loc["040301", "MONTO "]
    material_mantencion = exported.loc["0410", "MONTO "]
    material_aseo = exported.loc["040702", "MONTO "]
    material_casino = exported.loc["0408", "MONTO "]
    vestuario_y_calzado = exported.loc["0202", "MONTO_SUBASIGNACIONES"]
    alimentacion_viveres_pacientes = exported.loc["010101", "MONTO "]
    alimentacion_viveres_funcionarios = exported.loc["010102", "MONTO "]
    combustible_y_lubricante_calefaccion = exported.loc["0303", "MONTO "]
    material_curacion = exported.loc["040403", "MONTO "]
