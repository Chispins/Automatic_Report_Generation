...
def process_data(folder_path):
    ...
    try:
        ...
        sheet = os.path.basename(os.getcwd())

        devengado = pd.read_excel(devengado_file, skiprows=5, header=0, sheet_name=sheet)
        ...
        ####
        exported_v3 = exported_v3["MONTO "] / 2
        exported_v3 = calculate_subasignaciones_amounts(exported_v3)
